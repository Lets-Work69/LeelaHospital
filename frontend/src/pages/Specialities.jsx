...
const specialities = [
  ...
  { title: 'Paediatrics & Neonatology',      slug: 'paediatrics-neonatology',      icon: '/services%20icons/pediatrics_17942024.webp', desc: 'At Leela Hospital, our Pediatric and Neonatology Department is dedicated to providing comprehensive and compassionate care for your little ones.' },
  ...
  { title: 'Urology',                        slug: 'urology',                      icon: '/services%20icons/urinary_7857026.webp', desc: 'Our team of skilled urologists specializes in diagnosing and treating a wide range of urological conditions affecting both men and women.' },
  ...
  { title: 'ENT',                            slug: 'ent',                          icon: '/services%20icons/nose.webp', desc: 'At Leela Hospital, we prioritize your ear, nose, and throat health with dedicated expertise and compassionate care. Our ENT specialists are here for you.' },
  ...
  { title: 'Nephrology',                     slug: 'nephrology',                   icon: '/services%20icons/organ.webp', desc: 'Our Nephrology Department at Leela Hospital is dedicated to providing comprehensive and compassionate care for patients with kidney conditions.' },
  ...
  { title: 'Laparoscopy & Endoscopy',        slug: 'laparoscopy-endoscopy',        icon: '/services%20icons/laparoscopy_8670713.webp', desc: 'Laparoscopic surgery, also known as minimally invasive surgery, is a modern surgical technique that involves performing operations through small incisions.' },
  { title: 'Psychiatry',                     slug: 'psychiatry',                   icon: '/services%20icons/mental-health.webp', desc: 'At Leela Hospital, we understand the crucial role mental health plays in overall well-being. Our team of dedicated psychiatrists is here to support you.' },
